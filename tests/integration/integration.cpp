...
protected:
  ...
  koinos::crypto::private_key alice_private_key;
  koinos::crypto::private_key bob_private_key;

  virtual void SetUp()
  {
    fixture = std::make_unique< koinos::tests::fixture >( "integration", "info" );
  ...
  koinos::rpc::chain::submit_transaction_request transfer_request()
  {
    ...
    *op3->add_args() =
    ...
    // to
    *op3->add_args() =
      koinos::util::converter::as< std::string >( bob_private_key.get_public_key()->to_address_bytes() );
    // value
