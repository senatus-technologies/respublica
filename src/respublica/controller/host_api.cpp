...
std::error_code host_api::respublica_get_caller( char* ret_ptr, std::uint32_t* ret_len )
{
...
std::error_code host_api::respublica_check_authority( const char* account_ptr, std::uint32_t account_len, bool* value )
{
