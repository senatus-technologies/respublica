...
function(koinos_add_format)
  ...
  if (NOT CLANG_FORMAT)
    ...
    get_target_property(TARGET_HEADER_SETS ${KOINOS_ADD_FORMAT_TARGET} HEADER_SETS)
    get_target_property(TARGET_INTERFACE_HEADER_SETS ${KOINOS_ADD_FORMAT_TARGET} INTERFACE_HEADER_SETS)

    foreach(HEADER_SET_NAME ${TARGET_HEADER_SETS})
      set(HEADER_SET_PROPERTY "HEADER_SET_${HEADER_SET_NAME}")
      get_target_property(TARGET_HEADERS ${KOINOS_ADD_FORMAT_TARGET} ${HEADER_SET_PROPERTY})
