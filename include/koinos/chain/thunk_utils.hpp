...
#define _THUNK_REGISTRATION_GENESIS( r, data, i, elem )                                                                \
  data.register_genesis_thunk< BOOST_PP_CAT( elem, _THUNK_ARGS_SUFFIX ), BOOST_PP_CAT( elem, _THUNK_RET_SUFFIX ) >(    \
    chain::system_call_id::elem,                                                                                       \
    thunk::BOOST_PP_CAT( _, elem ) );
...
#define _THUNK_REGISTRATION( r, data, i, elem )                                                                        \
  data.register_thunk< BOOST_PP_CAT( elem, _THUNK_ARGS_SUFFIX ), BOOST_PP_CAT( elem, _THUNK_RET_SUFFIX ) >(            \
    chain::system_call_id::elem,                                                                                       \
    thunk::BOOST_PP_CAT( _, elem ) );

#define THUNK_REGISTER( dispatcher, args ) BOOST_PP_SEQ_FOR_EACH_I( _THUNK_REGISTRATION, dispatcher, args )

#define VA_ARGS( ... ) , ##__VA_ARGS__

#define THUNK_DECLARE( return_type, name, ... )                                                                        \
  namespace thunk {                                                                                                    \
  return_type BOOST_PP_CAT( _, name )( execution_context & VA_ARGS( __VA_ARGS__ ) );                                   \
  }                                                                                                                    \
  namespace system_call {                                                                                              \
  BOOST_PP_IF( _THUNK_IS_VOID( return_type ),                                                                          \
               void,                                                                                                   \
...
#define THUNK_DECLARE_VOID( return_type, name )                                                                        \
  namespace thunk {                                                                                                    \
  return_type BOOST_PP_CAT( _, name )( execution_context& );                                                           \
  }                                                                                                                    \
  namespace system_call {                                                                                              \
  BOOST_PP_IF( _THUNK_IS_VOID( return_type ),                                                                          \
               void,                                                                                                   \
...
#define _THUNK_DETAIL_DEFINE_ARGS( args )                                                                              \
  BOOST_PP_SEQ_FOR_EACH_I( _THUNK_DETAIL_DEFINE_ARGS_EACH, data, BOOST_PP_VARIADIC_TO_SEQ args )
#define _THUNK_DETAIL_DEFINE_FORWARD( args )                                                                           \
  BOOST_PP_SEQ_FOR_EACH_I( _THUNK_DETAIL_DEFINE_FORWARD_EACH, data, BOOST_PP_VARIADIC_TO_SEQ args )
#define _THUNK_DETAIL_DEFINE_TYPES( args )                                                                             \
  BOOST_PP_SEQ_FOR_EACH_I( _THUNK_DETAIL_DEFINE_TYPES_EACH, data, BOOST_PP_VARIADIC_TO_SEQ args )

namespace koinos::chain::detail {
inline void set_message_field( google::protobuf::Message& msg, uint32_t index, int64_t value )
{
...
inline void set_message_field( google::protobuf::Message& msg, uint32_t index, uint64_t value )
{
  auto desc = msg.GetDescriptor();
  auto ref  = msg.GetReflection();
  auto fd   = desc->FindFieldByNumber( index );
...
inline void set_message_field( google::protobuf::Message& msg, uint32_t index, int32_t value )
{
  auto desc = msg.GetDescriptor();
  auto ref  = msg.GetReflection();
  auto fd   = desc->FindFieldByNumber( index );
...
inline void set_message_field( google::protobuf::Message& msg, uint32_t index, uint32_t value )
{
  auto desc = msg.GetDescriptor();
  auto ref  = msg.GetReflection();
  auto fd   = desc->FindFieldByNumber( index );
...
inline void set_message_field( google::protobuf::Message& msg, uint32_t index, bool value )
{
  auto desc = msg.GetDescriptor();
  auto ref  = msg.GetReflection();
  auto fd   = desc->FindFieldByNumber( index );
...
inline void set_message_field( google::protobuf::Message& msg, uint32_t index, const std::string& value )
{
  auto desc = msg.GetDescriptor();
  auto ref  = msg.GetReflection();
  auto fd   = desc->FindFieldByNumber( index );
...
inline void set_message_field( google::protobuf::Message& msg, uint32_t index, const google::protobuf::Message& value )
{
  auto desc = msg.GetDescriptor();
  auto ref  = msg.GetReflection();
  auto fd   = desc->FindFieldByNumber( index );
...
inline void set_message_field( google::protobuf::Message& msg, uint32_t index, const std::vector< uint64_t >& values )
{
  auto desc = msg.GetDescriptor();
  auto ref  = msg.GetReflection();
  auto fd   = desc->FindFieldByNumber( index );
...
inline void set_message_field( google::protobuf::Message& msg, uint32_t index, const std::vector< int64_t >& values )
{
  auto desc = msg.GetDescriptor();
  auto ref  = msg.GetReflection();
  auto fd   = desc->FindFieldByNumber( index );
...
inline void set_message_field( google::protobuf::Message& msg, uint32_t index, const std::vector< uint32_t >& values )
{
  auto desc = msg.GetDescriptor();
  auto ref  = msg.GetReflection();
  auto fd   = desc->FindFieldByNumber( index );
...
inline void set_message_field( google::protobuf::Message& msg, uint32_t index, const std::vector< int32_t >& values )
{
  auto desc = msg.GetDescriptor();
  auto ref  = msg.GetReflection();
  auto fd   = desc->FindFieldByNumber( index );
...
inline void set_message_field( google::protobuf::Message& msg, uint32_t index, const std::vector< bool >& values )
{
  auto desc = msg.GetDescriptor();
  auto ref  = msg.GetReflection();
  auto fd   = desc->FindFieldByNumber( index );
...
inline void
set_message_field( google::protobuf::Message& msg, uint32_t index, const std::vector< std::string >& values )
{
  auto desc = msg.GetDescriptor();
  auto ref  = msg.GetReflection();
  auto fd   = desc->FindFieldByNumber( index );
...
template< typename T >
std::enable_if_t< std::is_base_of_v< google::protobuf::Message, T >, void > inline set_message_field(
...
#define _THUNK_ARG_PACK( FIRST, ... )                                                                                  \
  BOOST_PP_LIST_FOR_EACH_I( _THUNK_DETAIL_ARG_PACK, _args, BOOST_PP_TUPLE_TO_LIST( ( __VA_ARGS__ ) ) )
...
#define _THUNK_DETAIL_DEFINE( RETURN_TYPE, SYSCALL, ARGS, TYPES, FWD )                                                 \
  ...
  {                                                                                                                    \
    ...
    with_stack_frame(                                                                                                  \
      context,                                                                                                         \
      stack_frame{ .sid = _sid, .call_privilege = privilege::kernel_mode },                                            \
      [ & ]()                                                                                                          \
      {                                                                                                                \
...
#define THUNK_DEFINE( RETURN_TYPE, SYSCALL, ... )                                                                      \
  _THUNK_DETAIL_DEFINE( RETURN_TYPE,                                                                                   \
                        SYSCALL,                                                                                       \
...
#define THUNK_DEFINE_VOID( RETURN_TYPE, SYSCALL ) _THUNK_DETAIL_DEFINE( RETURN_TYPE, SYSCALL, , , )
