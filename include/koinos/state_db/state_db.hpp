...
class anonymous_state_node final: public abstract_state_node,
                                  public std::enable_shared_from_this< anonymous_state_node >
{
public:
...
class state_node final: public abstract_state_node,
                        public std::enable_shared_from_this< state_node >
{
public:
  state_node();
  ~state_node();
...
public:
   ...
   */
  state_node_ptr
  get_node_at_revision( uint64_t revision, const state_node_id& child_id, const shared_lock_ptr& lock ) const;
   ...
   */
  state_node_ptr
  get_node_at_revision( uint64_t revision, const state_node_id& child_id, const unique_lock_ptr& lock ) const;
