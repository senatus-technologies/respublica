...
template<>
struct std::is_error_code_enum< respublica::vm::virtual_machine_errc >: public std::true_type
{};

template<>
struct std::is_error_code_enum< respublica::vm::wasi_errc >: public std::true_type
{};
